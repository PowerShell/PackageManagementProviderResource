...
Import-LocalizedData -BindingVariable LocalizedData -filename MSFT_OneGetSource.strings.psd1
...
function Get-TargetResource
{
    ...
    #Validate Uri and add Location because OneGet uses Location not SourceUri. 
    ...
    $source = OneGet\Get-PackageSource @PSBoundParameters -ForceBootstrap -ErrorAction SilentlyContinue -WarningAction SilentlyContinue  
...
function Set-TargetResource
{
    ...
    #Add Location because OneGet uses Location not SourceUri. 
    $PSBoundParameters.Add("Location", $SourceUri)
    ...
    {   
        ...
        OneGet\Register-PackageSource @extractedArguments -Force -ErrorVariable ev  
    ...
    else 
    {
        ...
        OneGet\Unregister-PackageSource @extractedArguments -Force -ErrorVariable ev 
